    ...
    with gr.Blocks(title=brand.get("product_short", "达芬七 Z-Image")) as demo:
        ...
        with gr.Tabs(elem_id="dv-main-tabs"):
            ...
            with gr.Tab("文生图"):
                ...
                def _weight_update_for_style(lab: str):
                    st = resolve_style_name(lab)
                    ...
                    return gr.update(
                        value=_weight_label_for_style(lab),
                        interactive=True,
                    )
                ...
                def _on_style_del(lab: str, cat_f):
                    ...
                    if not st:
                        return (
                            '<div class="dv-status err">请先选择要删除的用户风格</div>',
                            gr.skip(),
                            gr.skip(),
                            gr.skip(),
                            gr.skip(),
                ...
                def _run_t2i(
                    ...
                    print(
                        ...
                        f"lora={st.file if st else None}  w={ww1}{size_note}",
                        flush=True,
                    )
                    try:
